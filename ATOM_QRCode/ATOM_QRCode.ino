...
void setup() {
  ...
  Serial2.begin(9600, SERIAL_8N1, 22, 19); // Set the baud rate of serial port 2 to 115200,8 data bits, no parity bits, and 1 stop bit, and set RX to 22 and TX to 19.
